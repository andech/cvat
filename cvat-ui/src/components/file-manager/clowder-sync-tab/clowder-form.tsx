...
import { Button, Icon, Input, Popover, Row } from 'antd';
...
function ClowderForm(): JSX.Element {
    ...
    const renderPopoverTitle = (): JSX.Element => (
        <>
            <Icon type='question-circle' theme='twoTone' style={{ marginRight: '8px' }} />
    ...
    return (
        <>
            ...
            <Row>
                ...
                <Row className='cvat-clowder-sync-tab-synchronize-field'>
                    <Input
                    ...
                    <Button className='cvat-clowder-sync-tab-btn' type='primary' icon='cloud-sync-o' onClick={onSync}>
                        Synchronize
                    </Button>
                </Row>
            </Row>
